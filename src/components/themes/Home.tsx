...
import LogoComp from './otherComp/LogoComp';
...
import { YinYang } from './otherComp/styleDesgin';
    ...
    return (
        <MainContainer>
         <DarkDiv   click={click}/>
            ...
            <Contact target="_blank" href="mailto:anuragchoudhary9414@gmail.com">
                <motion.h2
                initial={{
                    y:-200,
            ...
            <WORK to="/Projects"  isClicked={click}>
          <motion.h2
            initial={{
              y: -200,
            }}
